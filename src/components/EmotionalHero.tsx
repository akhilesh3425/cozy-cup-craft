...
import heroImage from "@/assets/hero-coffee-morning.jpg";
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(12)].map((_, i) => (
          <Coffee
            key={i}
            className="absolute text-accent/20 animate-pulse"
            style={{
      ...
      <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-6">
        ...
        <p className="text-xl md:text-2xl mb-4 text-white/90 max-w-3xl mx-auto leading-relaxed">
          From the first gentle aroma that fills your kitchen to that perfect moment of warmth between your hands,
        </p>
        <p className="text-lg md:text-xl mb-12 text-accent font-medium max-w-2xl mx-auto">
        ...
        {/* Social Proof */}
        <div className="text-center">
          <p className="text-white/70 mb-4">Trusted by coffee lovers worldwide</p>
          <div className="flex justify-center items-center gap-6 text-accent">
            ...
            <span className="text-white/80 ml-2">4.8/5 from 50,000+ reviews</span>
          </div>
        </div>
      </div>
